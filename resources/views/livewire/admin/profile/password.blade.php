    ...
    <div class="container-fluid">
        <div class="d-flex flex-column flex-sm-row align-items-center bg-white rounded-3 border shadow-sm p-3">
            ...
            <div class="ms-0 ms-md-4 mb-3">
                <p class="fs-5 fw-bold text-color">Ubah Password Akun</p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="mb-3 text-center py-3">
                        ...
                        <p class="fs-4 fw-bold text-color">Ubah Password</p>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="answer" class="form-label">Konfirmasi Password</label>
