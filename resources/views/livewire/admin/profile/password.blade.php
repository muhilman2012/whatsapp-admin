    ...
    <div class="container-fluid">
        <div class="d-flex flex-column flex-sm-row align-items-center bg-white rounded-3 border shadow-sm p-3">
            ...
            <div class="ms-0 ms-md-4 mb-3">
                <p class="fs-5 fw-bold text-color">Ubah Kata Sandi Akun</p>
                <p class="text-secondary mb-0">Akun Anda</p>
                <p class="mb-4 text-color">{{ auth('admin')->user()->email }}</p>
                <button wire:click='show' type="button" class="btn btn-blue rounded-0">Ubah Kata Sandi</button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="mb-3 text-center py-3">
                        ...
                        <p class="fs-4 fw-bold text-color">Ubah Kata Sandi</p>
                    </div>
                    <div class="mb-3">
                        <label for="question" class="form-label">Kata Sandi</label>
                    ...
                    <div class="mb-3">
                        <label for="answer" class="form-label">Konfirmasi Kata Sandi</label>
